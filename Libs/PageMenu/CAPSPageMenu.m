...
- (void)initValues
{
    ...
    _selectionIndicatorColor      = [UIColor colorWithRed:242.0f/255.0f green:222.0f/255.0f blue:138.0f/255.0f alpha:1.0];
    _selectedMenuItemLabelColor   = [UIColor colorWithRed:74.0f/255.0f green:48.0f/255.0f blue:75.0f/255.0f alpha:1.0];

    _unselectedMenuItemLabelColor = [UIColor lightGrayColor];
    _scrollMenuBackgroundColor    = [UIColor clearColor];
    ...
    _menuItemFont = [UIFont fontWithName:@"Alcubierre" size:15.0];//[UIFont systemFontOfSize:15.0];
